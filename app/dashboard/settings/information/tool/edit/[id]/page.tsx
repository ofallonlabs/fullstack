import ToolsFormWrapper from "@/ui/components/dashboard/forms/mentee/wrappers/tools-form-wrapper";
import { headers } from "next/headers";
import { auth } from "@/lib/auth/auth";
import { getMentee } from "@/lib/db/services/mentee-service";

export default async function EditToolsPage({ params }: { params: Promise<{ id: string }> } ){
        ...
        <div className="relative mb-32 divide-y-4 divide-brand-100">
            ...
            <div className="bg-white">
                <div className="py-8 px-2 md:px-4 md:w-9/12 lg:w-8/12 xl:w-7/12">
                    <ToolsFormWrapper formType={{method:"EDIT", id: id}} menteeId={targetId}  />
                </div>
