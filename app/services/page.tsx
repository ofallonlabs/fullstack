                                            ...
                                            <div className="flex-1 flex flex-col py-2 md:py-0">                                                                  
                                                ...
                                                <div className="order-1 md:order-2 px-2 flex flex-col items-start justify-start">
                                                    ...
                                                    <div className="text-gray-700 md:text-sm lg:text-base text-left mt-6 hidden md:block">
                                                        <p className="overflow-hidden text-ellipsis md:text-clip h-[100px]">
                                                ...
                                                <div className="order-3 md:order-4 px-2 flex flex-row justify-between items-center gap-1 text-gray-600 text-base lg:text-lg pt-3 md:pt-0 md:pb-3">
                                                ...
                                                <div className="order-5 md:order-5 py-4 px-2 hidden md:block">
                                                    <div className="flex flex-row w-full justify-center items-center gap-2 text-md text-slate-500 font-light">
                                                        <Link href={"/auth/login"} className="transition-all duration-200 bg-brand-500 hover:bg-brand-600 text-white font-semibold  px-10 py-2 rounded-md text-center w-full text-center">
                                                            Apply Now
                                                        </Link>
                                                    </div>                                   
                                                </div>
